                ...
                >
                    <NuxtLink :to="`/vehicles/${vehicle.id}`">
                        ...
                        <div class="vehicle-content">
                            ...
                            <p><span>Device Name:</span> {{ vehicle.device_name }}</p>
                        </div>
                    </NuxtLink>
                </div>
            </div>
...
<style lang="scss">
    ...
    .vehicle-list {
        .vehicle a {
            ...
            padding: 15px 20px;
            margin-bottom: 20px;
            background-color: rgba(0, 73, 130, .8);
            text-decoration: none;

            &:hover, &:active, &:focus {
                background-color: rgba(0, 73, 130, .9);
            }
